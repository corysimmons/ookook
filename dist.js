...
var OokConfig = function OokConfig(_ref) {
  var _ref$breakpoints = _ref.breakpoints,
    ...
    desktop: '1440px'
      ...
      _ref$cssProperties = _ref.cssProperties,
      cssProperties = _ref$cssProperties === void 0 ? _knownCssProperties["default"].all : _ref$cssProperties,
...
var Ook = function Ook(_ref2) {
  var _OokContext$, _OokContext$Consumer, _OokContext$Consumer$, _OokContext$2, _OokContext$Consumer2, _OokContext$Consumer3;
  ...
  var cssProperties = OokContext['1'] ? (_OokContext$2 = OokContext['1']) === null || _OokContext$2 === void 0 ? void 0 : _OokContext$2.cssProperties : (OokContext === null || OokContext === void 0 ? void 0 : (_OokContext$Consumer2 = OokContext.Consumer) === null || _OokContext$Consumer2 === void 0 ? void 0 : (_OokContext$Consumer3 = _OokContext$Consumer2._currentValue) === null || _OokContext$Consumer3 === void 0 ? void 0 : _OokContext$Consumer3.cssProperties) ? OokContext.Consumer._currentValue.cssProperties : [];
  ...
  var jsonifiedProps = props;
  var styledString = Object.entries(props).reduce(function (acc, _ref3) {
    ...
    if (cssProperties.includes(keb)) {
      if (_typeof(val) === 'object') {
        jsonifiedProps[key] = JSON.stringify(val); // Overwrite global breakpoint rules
  ...
  var S = (0, _styledComponents["default"])(el).withConfig({
    displayName: "ook__S",
    componentId: "sc-1e6ory2-0"
  })(["", ""], _mqpacker["default"].pack(styledString).css);
  return _react["default"].createElement(S, jsonifiedProps, children);
};
